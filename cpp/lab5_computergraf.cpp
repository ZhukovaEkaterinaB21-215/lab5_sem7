// lab5_computergraf.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include "pixel.h"
#include "draw_line.h"
#include "task1.h"
...
int main()
{
    ...
    imwrite("ortograf.png", img_task1_ort);
    ...
    imwrite("izometric.png", img_task1_izom);
    ...
    imwrite("diametric.png", img_task1_dia);
    ...
    imwrite("oblique.png", img_task1_obl);
    ...
    imwrite("perspective_visible.png", img_task3_perspective);
